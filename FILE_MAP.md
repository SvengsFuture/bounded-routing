...
Public entry point. Mechanism summary, current status, V4 shape-gate result, scar-layer result, cellular-shedding result, scope boundaries, and repository status. Start here.
